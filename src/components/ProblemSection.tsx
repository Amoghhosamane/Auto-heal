...
export const ProblemSection: React.FC = () => {
  ...
  return (
    <section id="problem" className="py-24 border-b border-midnight-800 bg-midnight-950">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-semibold tracking-tight text-white mb-4">
            ...
            <span className="text-slate-400 font-normal">Manual triage cannot keep up.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {problems.map((item, index) => {
            ...
            return (
              <div 
                key={index}
                className="p-7 rounded-xl bg-midnight-900/60 border border-midnight-800 hover:border-healblue-800 transition-colors flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-10 h-10 rounded-lg bg-midnight-850 border border-midnight-750 flex items-center justify-center text-healblue-400 group-hover:border-healblue-600 transition-colors">
                  ...
                  <div className="text-xs font-mono text-healblue-300 mb-3">
                    {item.subtitle}
                  </div>
                ...
                <div className="pt-4 border-t border-midnight-800/80 flex items-center justify-between text-xs">
                  <span className="text-slate-400">SLA Consequence:</span>
                  <span className="font-mono text-healblue-200">{item.impact}</span>
                </div>
              </div>
            );
          })}
